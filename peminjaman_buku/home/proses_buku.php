...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["simpan"])) {
    ...
    $sql = "INSERT INTO tb_buku (kode_buku, judul_buku, pengarang, penerbit, tahun_terbit, isbn, jumlah_buku, jumlah_salinan, kategori_buku, deskripsi_buku, gambar_sampul) VALUES ('$kode', '$judul', '$pengarang', '$penerbit', '$tahun', '$isbn', '$jumbuku', '$jumsalin', '$kategori', '$deskripsi', '$gambar')";
