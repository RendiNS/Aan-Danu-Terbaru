...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($status == 1) {
        $pesan = "Peminjaman buku $judul dengan jumlah $jumlah buku dari kelas $kelas telat dalam pengembalian,  Dan akan dikenakan Denda Sebesar Rp. ".number_format($denda).",-.";
