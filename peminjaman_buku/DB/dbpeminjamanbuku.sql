...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Okt 2024 pada 17.46
...
(4, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'ADMIN', 'Empat Negeri', '+6282361676990', 'admin', 'admin/admin-avatar.png'),
(6, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'USER', 'Empat Negeri', '+6283877654098', 'user', 'admin/u6.jpg'),
(11, 'difa', '7726a3674fbfab26b520ddac1d28818c', 'DIFA', '-', '0', 'user', 'admin/u3.jpg');
...
INSERT INTO `tb_buku` (`id_buku`, `kode_buku`, `judul_buku`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `jumlah_buku`, `jumlah_salinan`, `kategori_buku`, `deskripsi_buku`, `gambar_sampul`) VALUES
(1, 'BKU01', 'Laskar Pelangi', 'Andrea Hirata', 'Bentang Pustaka', '2005', '123546BND', 43, 50, 10, 'Novel yang mengisahkan tentang perjuangan sekelompok anak muda di Pulau Belitong dalam mencari pendidikan yang layak. Cerita ini penuh dengan warna-warni persahabatan, semangat juang, dan perjuangan melawan keterbatasan.', 'laskar.jpeg'),
(2, 'BKU02', 'Bumi Manusia', 'Pramoedya Ananta Toer', 'Hasta Mitra', '1980', '-', 40, 45, 2, 'Novel sejarah epik yang mengisahkan perjalanan Minke, seorang pemuda Jawa yang mencoba melawan penjajahan kolonial Belanda dan mengejar cita-cita kebebasan dan kesetaraan.', 'bumi.jpeg'),
(3, 'BKU03', 'Hujan Bulan Juni', 'Sapardi Djoko Damono', 'Gramedia Pustaka Utama', '1994', '-', 24, 50, 11, ' Kumpulan puisi yang indah dan mendalam, mengungkapkan perasaan, pemikiran, dan refleksi pengarang tentang kehidupan, cinta, dan alam, serta memberikan wawasan mendalam tentang perasaan manusia.', 'hujan.jpeg'),
(4, 'BKU04', 'Indonesia: Sejarah Singkat', 'Merle C. Ricklefs', 'The Modern Library', '2008', '-', 40, 50, 2, 'Buku ini memberikan gambaran singkat tentang sejarah Indonesia, dari masa pra-sejarah hingga zaman modern. Cocok untuk siswa yang ingin memahami perkembangan dan dinamika sejarah Indonesia.', 'singkat.jpeg');
...
INSERT INTO `tb_denda` (`id_denda`, `denda`) VALUES
(1, 15000);
...
(13, 1, 1, '2023-11-20', 'X', '2023-11-20', '2023-11-21', 3, 30, 'Segera Kembalikan setelah digunakan');
